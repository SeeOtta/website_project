...
if (isValid()) {
    ...
    $recaptcha_secret = '6LcyTwojAAAAAHDttj-xYVNaTSki6HMomOquwhKZ'; // Secret key
    ...
    if($recaptcha->success == true && $recaptcha->score >= 0.5 && $recaptcha->action == "fcf-form-id"){ // If the response is valid
